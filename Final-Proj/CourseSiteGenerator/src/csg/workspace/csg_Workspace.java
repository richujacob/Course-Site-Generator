...
public class csg_Workspace extends AppWorkspaceComponent {
    ...
    ComboBox teams;
    ObservableList<String> role_Options;
    ComboBox role;
...
//       );
       ...
       role_Options = FXCollections.observableArrayList(
               props.getProperty(csg_Prop.ROLE_LEADDES.toString()),
               props.getProperty(csg_Prop.ROLE_LEADPROG.toString()),
               props.getProperty(csg_Prop.ROLE_PROJMANAGER.toString()),
               props.getProperty(csg_Prop.ROLE_DATA.toString())
       );
       
       role = new ComboBox(role_Options);
