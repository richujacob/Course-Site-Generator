 ...
 * @version 1.0
 */
public class csg_Style extends AppStyleComponent {
     ...
     */
    public csg_Style(AppTemplate initApp) {
        // KEEP THIS FOR LATER
        app = initApp;
    ...
    private void initTAWorkspaceStyle() {
        ...
        // LEFT SIDE - THE TABLE
        TableView<csg_TeachingAssistant> taTable = workspaceComponent.getTATable();
